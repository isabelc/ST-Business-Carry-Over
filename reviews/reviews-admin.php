...
{	var $parentClass = '';
    ...
    function show_options() {
        ...
        echo '
        <div class="postbox" style="width:700px;"><h3>'. __('Display Options', 'st-business-carry-over') .'</h3><div id="smar_ad">
               <form method="post" action="">
			   <div style="background:#eaf2fa;padding:6px;border-top:1px solid #ccc;border-bottom:1px solid #ccc;"><legend>'. __('Review Page Settings', 'st-business-carry-over'). '</legend></div>
                    <div style="padding:10px;padding-bottom:10px;"><label for="reviews_per_page">'. __('Reviews shown per page: ', 'st-business-carry-over') . '</label><input style="width:40px;" type="text" id="reviews_per_page" name="reviews_per_page" value="'.$this->options['reviews_per_page'].'" />
                        <br /><br />
                        <label for="form_location">'. __('Location of Review Form: ', 'st-business-carry-over'). '</label>
                        <select id="form_location" name="form_location">
                            <option ';if ($this->options['form_location'] == 0) { echo "selected"; } echo ' value="0">'. __('Above Reviews', 'st-business-carry-over'). '</option>
                            <option ';if ($this->options['form_location'] == 1) { echo "selected"; } echo ' value="1">'. __('Below Reviews', 'st-business-carry-over'). '</option>                     </select>
                        <br /><br />
                        <label>'. __('Fields to ask for on review form: ', 'st-business-carry-over'). '</label>
                        <input data-what="fname" id="ask_fname" name="ask_fields[]" type="checkbox" '.$af['fname'].' value="fname" />&nbsp;<label for="ask_fname"><small>'. __('Name', 'st-business-carry-over'). '</small></label>&nbsp;&nbsp;&nbsp;
                        <input data-what="femail" id="ask_femail" name="ask_fields[]" type="checkbox" '.$af['femail'].' value="femail" />&nbsp;<label for="ask_femail"><small>'. __('Email', 'st-business-carry-over'). '</small></label>&nbsp;&nbsp;&nbsp;
                        <input data-what="fwebsite" id="ask_fwebsite" name="ask_fields[]" type="checkbox" '.$af['fwebsite'].' value="fwebsite" />&nbsp;<label for="ask_fwebsite"><small>'. __('Website', 'st-business-carry-over'). '</small></label>&nbsp;&nbsp;&nbsp;
                        <input data-what="ftitle" id="ask_ftitle" name="ask_fields[]" type="checkbox" '.$af['ftitle'].' value="ftitle" />&nbsp;<label for="ask_ftitle"><small>'. __('Review Title', 'st-business-carry-over'). '</small></label>
                        <br /><br />
                        <label>'. __('Fields to require on review form: ', 'st-business-carry-over'). '</label>
                        <input id="require_fname" name="require_fields[]" type="checkbox" '.$rf['fname'].' value="fname" />&nbsp;<label for="require_fname"><small>'. __('Name', 'st-business-carry-over'). '</small></label>&nbsp;&nbsp;&nbsp;
                        <input id="require_femail" name="require_fields[]" type="checkbox" '.$rf['femail'].' value="femail" />&nbsp;<label for="require_femail"><small>'. __('Email', 'st-business-carry-over'). '</small></label>&nbsp;&nbsp;&nbsp;
                        <input id="require_fwebsite" name="require_fields[]" type="checkbox" '.$rf['fwebsite'].' value="fwebsite" />&nbsp;<label for="require_fwebsite"><small>'. __('Website', 'st-business-carry-over'). '</small></label>&nbsp;&nbsp;&nbsp;
                        <input id="require_ftitle" name="require_fields[]" type="checkbox" '.$rf['ftitle'].' value="ftitle" />&nbsp;<label for="require_ftitle"><small>'. __('Review Title', 'st-business-carry-over'). '</small></label>
                        <br /><br />
                        <label>'. __('Fields to show on each approved review: ', 'st-business-carry-over'). '</label>
                        <input id="show_fname" name="show_fields[]" type="checkbox" '.$sf['fname'].' value="fname" />&nbsp;<label for="show_fname"><small>'. __('Name', 'st-business-carry-over'). '</small></label>&nbsp;&nbsp;&nbsp;
                        <input id="show_femail" name="show_fields[]" type="checkbox" '.$sf['femail'].' value="femail" />&nbsp;<label for="show_femail"><small>'. __('Email', 'st-business-carry-over'). '</small></label>&nbsp;&nbsp;&nbsp;
                        <input id="show_fwebsite" name="show_fields[]" type="checkbox" '.$sf['fwebsite'].' value="fwebsite" />&nbsp;<label for="show_fwebsite"><small>'. __('Website', 'st-business-carry-over'). '</small></label>&nbsp;&nbsp;&nbsp;
                        <input id="show_ftitle" name="show_fields[]" type="checkbox" '.$sf['ftitle'].' value="ftitle" />&nbsp;<label for="show_ftitle"><small>'. __('Review Title', 'st-business-carry-over'). '</small></label>
                        <br />
                        <small>'. __('It is usually NOT a good idea to show email addresses publicly.', 'st-business-carry-over'). '</small>
                        <br /><br />
                        <label>'. __('Custom fields on review form: ', 'st-business-carry-over'). '</label>(<small>'. __('You can type in the names of any additional fields you would like here.', 'st-business-carry-over'). '</small>)
                        ...
                        <br /><br />
                        <label for="title_tag">'. __('Heading to use for Review Titles: ', 'st-business-carry-over'). '</label>
                        ...
                        <br /><br />
                        <label for="goto_show_button">'. __('Show review form: ', 'st-business-carry-over'). '</label><input type="checkbox" id="goto_show_button" name="goto_show_button" value="1" '.$goto_show_button_checked.' />
                        <br />
                        <small>'. __('If this option is unchecked, there will be no visible way for visitors to submit reviews.', 'st-business-carry-over'). '</small>
                        <br /><br />
                        <label for="goto_leave_text">'. __('Button text used to show review form: ', 'st-business-carry-over'). '</label><input style="width:250px;" type="text" id="goto_leave_text" name="goto_leave_text" value="'.$this->options['goto_leave_text'].'" />
                        <br />
                        <small>'. __('This button will be shown above the first review.', 'st-business-carry-over'). '</small>
                        <br /><br />
                        <label for="leave_text">'. __('Text to be displayed above review form: ', 'st-business-carry-over'). '</label><input style="width:250px;" type="text" id="goto_leave_text" name="goto_leave_text" value="'.$this->options['goto_leave_text'].'" />
                        <br />
                        <small>'. __('This will be shown as a heading immediately above the review form.', 'st-business-carry-over'). '</small>
                        <br /><br />
                        <label for="submit_button_text">'. __('Text to use for review form submit button: ', 'st-business-carry-over'). '</label><input style="width:200px;" type="text" id="submit_button_text" name="submit_button_text" value="'.$this->options['submit_button_text'].'" />
                        <br />
                        <div class="submit" style="padding:10px 0px 0px 0px;"><input type="submit" class="button-primary" value="'. __('Save Changes', 'st-business-carry-over'). '" name="Submit"></div>
                    </div>';
    ...
    function security() {
        ...
        {
            wp_die( __('You do not have sufficient permissions to access this page.','st-business-carry-over') );
        }
    }
    ...
    function real_admin_options() {
		...
		if ($exists != $this->dbtable) {
			$exists = $wpdb->get_var("SHOW TABLES LIKE '$this->dbtable'");
			if ($exists != $this->dbtable) {
				print "<br /><br /><br /><p class='warning'>". __('COULD NOT CREATE DATABASE TABLE, PLEASE REPORT THIS ERROR', 'st-business-carry-over'). "</p>";
			}
		}
        
        if (!isset($this->p->Submit)) { $this->p->Submit = ''; }
        
        if ($this->p->Submit == __('Save Changes', 'st-business-carry-over')) {
        ...
        <div id="smar_respond_1" class="wrap">
            <h2>'. __('Smartest Reviews - Options', 'st-business-carry-over'). '</h2>';
            ...
            <div class="postbox" style="width:700px;">
                <h3 style="cursor:default;">'. __('About Smartest Reviews', 'st-business-carry-over'). '</h3>
                <div style="padding:10px; background:#ffffff;">
                    <p>'. __('Smartest Reviews allows your customers and visitors to leave reviews or testimonials of your business. Reviews are Schema.org Microdata enabled.', 'st-business-carry-over'). '<br /><br />'
					. sprintf(__('Activate Reviews by checking %s in the ST Business Carry Over settings.', 'st-business-carry-over'), '<code>Enable Reviews</code>' ).
'</p><br /> </div> </div>';
        $this->show_options();
        echo '<br /></div>';
    }
    ...
    function real_admin_view_reviews() {      
                ...
                switch ($this->p->action) {
                    ...
                    case 'update_field':
                        ...
                        if (!is_array($this->p->json)) {
                            ...
                            echo json_encode(array("errors" => __('Bad Request', 'st-business-carry-over')));
                            exit(); 
                        }
                            ...
                            switch ($col) {
                                case 'date_time':
                                    ...
                                    if (!$d || $d == '01/01/1970 12:00 am') {
                                        header('HTTP/1.1 403 Forbidden');
                                        echo json_encode(array("errors" => __('Bad Date Format', 'st-business-carry-over')));
                                        exit(); 
                                    }
                                    $show_val = $d;
                                ...
                                default:
                                    if ($val == '') {
                                        header('HTTP/1.1 403 Forbidden');
                                        echo json_encode(array("errors" => __('Bad Value', 'st-business-carry-over')));
                                        exit(); 
                                    }
        ...
        {
            case -1:
                $status_text = __('Submitted', 'st-business-carry-over');
                break;
            case 0:
                $status_text = __('Pending', 'st-business-carry-over');
                break;
            case 1:
                $status_text = __('Approved', 'st-business-carry-over');
                break;
            case 2:
                $status_text = __('Trashed', 'st-business-carry-over');
                break;
        }
        ...
        <div id="smar_respond_1" class="wrap">
            ...
            <h2><?php _e('Smartest Reviews', 'st-business-carry-over'); ?> - <?php echo sprintf(__('%s Reviews', 'st-business-carry-over'), $status_text); ?></h2>
              <ul class="subsubsub">
                <li class="all"><a <?php if ($this->p->review_status == -1) { echo 'class="current"'; } ?> href="?page=smar_view_reviews&amp;review_status=-1"><?php _e('All', 'st-business-carry-over'); ?></a> |</li>
                <li class="moderated"><a <?php if ($this->p->review_status == 0) { echo 'class="current"'; } ?> href="?page=smar_view_reviews&amp;review_status=0"><?php _e('Pending ', 'st-business-carry-over'); ?>
                    <span class="count">(<span class="pending-count"><?php echo $pending_count;?></span>)</span></a> |
                </li>
                <li class="approved"><a <?php if ($this->p->review_status == 1) { echo 'class="current"'; } ?> href="?page=smar_view_reviews&amp;review_status=1"><?php _e('Approved', 'st-business-carry-over'); ?>
                    <span class="count">(<span class="pending-count"><?php echo $approved_count;?></span>)</span></a> |
                </li>
                <li class="trash"><a <?php if ($this->p->review_status == 2) { echo 'class="current"'; } ?> href="?page=smar_view_reviews&amp;review_status=2"><?php _e('Trash', 'st-business-carry-over'); ?>
              ...
              <form method="GET" action="" id="search-form" name="search-form">
                  <p class="search-box">
                      <?php if ($this->p->s_orig): ?><span style='color:#c00;font-weight:bold;'><?php _e('RESULTS FOR: ', 'st-business-carry-over'); ?></span><?php endif; ?>
                      <label for="comment-search-input" class="screen-reader-text"><?php _e('Search Reviews:', 'st-business-carry-over'); ?></label> 
                      ...
                      <input type="submit" class="button" value="<?php _e('Search Reviews', 'st-business-carry-over'); ?>" />
                  </p>
              </form>
              ...
              <div class="tablenav">
                <div class="alignleft actions">
                      <select name="action">
                            <option selected="selected" value="-1"><?php _e('Bulk Actions', 'st-business-carry-over'); ?></option>
                            <option value="bunapprove"><?php _e('Unapprove', 'st-business-carry-over'); ?></option>
                            <option value="bapprove"><?php _e('Approve', 'st-business-carry-over'); ?></option>
                            <option value="btrash"><?php _e('Move to Trash', 'st-business-carry-over'); ?></option>
                            <option value="bdelete"><?php _e('Delete Forever', 'st-business-carry-over'); ?></option>
                      </select>&nbsp;
                      <input type="submit" class="button-secondary apply" name="act" value="<?php _e('Apply', 'st-business-carry-over'); ?>" id="doaction" /></div><br class="clear" /></div> <div class="clear"></div><table cellspacing="0" class="widefat comments fixed"><thead><tr><th style="" class="manage-column column-cb check-column" id="cb" scope="col"><input type="checkbox" /></th><th style="" class="manage-column column-author" id="author" scope="col"><?php _e('Author', 'st-business-carry-over'); ?></th><th style="" class="manage-column column-comment" id="comment" scope="col"><?php _e('Review', 'st-business-carry-over'); ?></th></tr>
                </thead>
                <tfoot>
                  <tr>
                    <th style="" class="manage-column column-cb check-column" scope="col"><input type="checkbox" /></th>
                    <th style="" class="manage-column column-author" scope="col"><?php _e('Author', 'st-business-carry-over'); ?></th>
                    <th style="" class="manage-column column-comment" scope="col"><?php _e('Review', 'st-business-carry-over'); ?></th>
                  </tr>
                </tfoot>
...
<?php echo sprintf(__('There are no %s reviews yet.', 'st-business-carry-over'), $status_text); ?> <br /><br /></td></tr>
<?php		}
                  foreach ($reviews as $review) {                    
                      ...
                      if ($review->reviewer_name == '') { $review->reviewer_name = __('Anonymous', 'st-business-carry-over'); }
...
<?php echo date(__('m/d/Y g:i a', 'st-business-carry-over'),strtotime(__($review->date_time,' smartestb'))); ?><!-- isa locale -->
                            </span>
                            <?php if ($review->status == 1) : ?>[<a target="_blank" href="<?php echo $this->parentClass->get_jumplink_for_review($review,$this->page); ?>"><?php _e('View Review on Page', 'st-business-carry-over'); ?></a>]<?php endif; ?>
                          </div>
                          <p>
                              <span style="font-size:13px;font-weight:bold;"><?php _e('Title:', 'st-business-carry-over'); ?>&nbsp;</span>
                             ...
                             <div style="font-size:13px;font-weight:bold;">
                                 <br />
                                 <?php _e('Official Response:', 'st-business-carry-over'); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 <span style="font-size:11px;font-style:italic;"><?php _e('Leave this blank if you do not want it to be public', 'st-business-carry-over'); ?></span>
                             </div>
                             <div class="best_in_place" 
                                    data-url='<?php echo $update_path; ?>'
                                    data-object='json'
                          ...
                          <div class="row-actions">
                            ...
                            <?php _e('Mark as Approved', 'st-business-carry-over'); ?></a>&nbsp;|&nbsp;</span>
                            ...
                            <?php _e('Mark as Unapproved', 'st-business-carry-over'); ?></a><?php if ($review->status != 2): ?>&nbsp;|&nbsp;<?php endif; ?></span>
                            ...
                            <?php _e('Move to Trash', 'st-business-carry-over'); ?></a><?php if ($review->status != 2): ?>&nbsp;|&nbsp;<?php endif; ?></span>
                            ...
                            <?php _e('Delete Forever', 'st-business-carry-over'); ?></a></span>
                          </div>
                        </td>
                      </tr>
                  <?php
              ...
              <div class="tablenav">
                <div class="alignleft actions" style="float:left;">
                      ...
                      <input type="submit" class="button-secondary apply" name="act2" value="<?php _e('Apply', 'st-business-carry-over'); ?>" id="doaction2" />
                </div>
